...
MONGO_URI = os.getenv("MONGO_URI", "mongodb://paneluser:123456@103.253.244.109:27017/panel")
BOT_TOKEN = os.getenv("8527431688:AAEEAkRXPc1AUkS7bkd5muw_ixKgpRM99gg", "")
OWNER_ID = int(os.getenv("OWNER_ID", "5465056934"))
...
PROXY_USERNAME = os.getenv("PROXY_USERNAME", "52a1eca8c6f8e2a1170a")
PROXY_PASSWORD = os.getenv("PROXY_PASSWORD", "1c0ec934098d02e5")
